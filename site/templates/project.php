...
<div class="site-container">
  ...
  <section class="site-content">
            ...
            <div class="page-desc">
                 <div class="page-desc-title"><h1><span class="txt anim-text-flow"><p><?php echo $page->title()->html() ?></p></span></h1></div>
                 <div class="page-desc-text"><?php echo $page->text()->kirbytext() ?></div>
            </div>
            ...
            <article class="project">
                ...
                <div class="project-assets">
                    ...
                    <?php foreach($page->images()->not('thumb.gif')->sortBy('sort', 'asc') as $image): ?>
